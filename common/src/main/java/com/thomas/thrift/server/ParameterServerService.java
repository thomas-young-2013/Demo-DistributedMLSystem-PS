...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2017-03-18")
public class ParameterServerService {
  ...
  public interface Iface {
    ...
    public Carrier check(String hostId, String tableId, int localIteration) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void check(String hostId, String tableId, int localIteration, org.apache.thrift.async.AsyncMethodCallback<Carrier> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Carrier check(String hostId, String tableId, int localIteration) throws org.apache.thrift.TException
    {
      send_check(hostId, tableId, localIteration);
      return recv_check();
    }

    public void send_check(String hostId, String tableId, int localIteration) throws org.apache.thrift.TException
    {
      check_args args = new check_args();
      args.setHostId(hostId);
      args.setTableId(tableId);
      args.setLocalIteration(localIteration);
      sendBase("check", args);
    }

    public Carrier recv_check() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void check(String hostId, String tableId, int localIteration, org.apache.thrift.async.AsyncMethodCallback<Carrier> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      check_call method_call = new check_call(hostId, tableId, localIteration, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class check_call extends org.apache.thrift.async.TAsyncMethodCall<Carrier> {
      private String hostId;
      private String tableId;
      private int localIteration;
      public check_call(String hostId, String tableId, int localIteration, org.apache.thrift.async.AsyncMethodCallback<Carrier> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.hostId = hostId;
        this.tableId = tableId;
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class check<I extends Iface> extends org.apache.thrift.ProcessFunction<I, check_args> {
      ...
      public check_result getResult(I iface, check_args args) throws org.apache.thrift.TException {
        check_result result = new check_result();
        result.success = iface.check(args.hostId, args.tableId, args.localIteration);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class check<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, check_args, Carrier> {
      public check() {
        super("check");
      }
      ...
      public void start(I iface, check_args args, org.apache.thrift.async.AsyncMethodCallback<Carrier> resultHandler) throws org.apache.thrift.TException {
        iface.check(args.hostId, args.tableId, args.localIteration,resultHandler);
      }
    }
  ...
  public static class check_args implements org.apache.thrift.TBase<check_args, check_args._Fields>, java.io.Serializable, Cloneable, Comparable<check_args>   {
    ...
    private static final org.apache.thrift.protocol.TField HOST_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("hostId", org.apache.thrift.protocol.TType.STRING, (short)1);
    private static final org.apache.thrift.protocol.TField TABLE_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("tableId", org.apache.thrift.protocol.TType.STRING, (short)2);
    private static final org.apache.thrift.protocol.TField LOCAL_ITERATION_FIELD_DESC = new org.apache.thrift.protocol.TField("localIteration", org.apache.thrift.protocol.TType.I32, (short)3);
    ...
    public String hostId; // required
    public String tableId; // required
    public int localIteration; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      HOST_ID((short)1, "hostId"),
      TABLE_ID((short)2, "tableId"),
      LOCAL_ITERATION((short)3, "localIteration");
    ...
    // isset id assignments
    private static final int __LOCALITERATION_ISSET_ID = 0;
    private byte __isset_bitfield = 0;
    public static final java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
      java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      ...
      tmpMap.put(_Fields.TABLE_ID, new org.apache.thrift.meta_data.FieldMetaData("tableId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      tmpMap.put(_Fields.LOCAL_ITERATION, new org.apache.thrift.meta_data.FieldMetaData("localIteration", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public check_args(check_args other) {
      ...
      this.localIteration = other.localIteration;
    }
    ...
    public void clear() {
      this.hostId = null;
      this.tableId = null;
      setLocalIterationIsSet(false);
      this.localIteration = 0;
    }
    ...
    public check_args setHostId(String hostId) {
      this.hostId = hostId;
      return this;
    }
    ...
    public check_args setTableId(String tableId) {
      this.tableId = tableId;
      return this;
    }
    ...
    public check_args setLocalIteration(int localIteration) {
      this.localIteration = localIteration;
      setLocalIterationIsSet(true);
      return this;
    }

    public void unsetLocalIteration() {
      __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __LOCALITERATION_ISSET_ID);
    }

    /** Returns true if field localIteration is set (has been assigned a value) and false otherwise */
    public boolean isSetLocalIteration() {
      return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __LOCALITERATION_ISSET_ID);
    }

    public void setLocalIterationIsSet(boolean value) {
      __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __LOCALITERATION_ISSET_ID, value);
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case LOCAL_ITERATION:
        if (value == null) {
          unsetLocalIteration();
        } else {
          setLocalIteration((Integer)value);
        }
        break;
    ...
    public boolean equals(check_args that) {
      ...
      boolean this_present_localIteration = true;
      boolean that_present_localIteration = true;
      if (this_present_localIteration || that_present_localIteration) {
        if (!(this_present_localIteration && that_present_localIteration))
          return false;
        if (this.localIteration != that.localIteration)
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + localIteration;
    ...
    public int compareTo(check_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetLocalIteration()).compareTo(other.isSetLocalIteration());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetLocalIteration()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.localIteration, other.localIteration);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("localIteration:");
      sb.append(this.localIteration);
      first = false;
      sb.append(")");
      return sb.toString();
    }
    ...
    private static class check_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<check_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, check_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 3: // LOCAL_ITERATION
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.localIteration = iprot.readI32();
                struct.setLocalIterationIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, check_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeFieldBegin(LOCAL_ITERATION_FIELD_DESC);
        oprot.writeI32(struct.localIteration);
        oprot.writeFieldEnd();
        oprot.writeFieldStop();
        oprot.writeStructEnd();
      }
  ...
  public static class check_result implements org.apache.thrift.TBase<check_result, check_result._Fields>, java.io.Serializable, Cloneable, Comparable<check_result>   {
    ...
    public check_result setSuccess(Carrier success) {
      this.success = success;
      return this;
    }
